...
export default function HomeFinal() {
  ...
  return (
    <div style={styles.container}>
      {/* SFONDO CON IMMAGINE ORIGINALE */}
      <img src={bgImage} alt="Background" style={styles.bgImg} />
      ...
      <div className="container" style={styles.content}>
        ...
        <div style={styles.diagramWrapper}>
          <svg viewBox="0 0 300 300" style={styles.svg}>
            ...
            {/* LINEE DINAMICHE (ATTIVE IN BASE AL NODO) */}
            {activeNode === 'humans' && (
              <>
            ...
            >
              <defs>
                <filter id="glow-humans" x="-30%" y="-30%" width="160%" height="160%">
              ...
              <circle
                cx="150" cy="50" r="20"
                fill={activeNode === 'humans' ? '#3fd0c9' : '#0b1015'}
                stroke="#3fd0c9"
                strokeWidth="2"
                filter={activeNode === 'humans' ? 'url(#glow-humans)' : 'none'}
              />
            ...
            >
              ...
              <circle
                cx="55" cy="215" r="20"
                fill={activeNode === 'ai' ? '#3fd0c9' : '#0b1015'}
                stroke="#3fd0c9"
                strokeWidth="2"
                filter={activeNode === 'ai' ? 'url(#glow-ai)' : 'none'}
              />
            ...
            >
              <defs>
                <filter id="glow-data" x="-30%" y="-30%" width="160%" height="160%">
                  <feGaussianBlur stdDeviation="4" result="blur" />
                  <feMerge>
                    <feMergeNode in="blur" />
                    <feMergeNode in="SourceGraphic" />
              ...
              <circle
                cx="245" cy="215" r="20"
                fill={activeNode === 'data' ? '#3fd0c9' : '#0b1015'}
                stroke="#3fd0c9"
                strokeWidth="2"
                filter={activeNode === 'data' ? 'url(#glow-data)' : 'none'}
              />
        ...
        {/* CARTA DINAMICA (MOSTRA IL NODO SELEZIONATO) */}
...
const styles = {
  ...
  overlay: {
    position: 'absolute',
    inset: 0,
    background: 'linear-gradient(180deg, rgba(11,16,21,0.65) 0%, rgba(11,16,21,0.95) 100%)',
  },
  content: {
    position: 'relative',
    zIndex: 2,
  ...
  title: {
    fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', // <-- NOME PIÙ PICCOLO
