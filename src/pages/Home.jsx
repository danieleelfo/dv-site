  ...
  return (
    <div style={pageStyles.page}>
      ...
      <div style={pageStyles.content}>
        ...
        <section
          className="section container home-section"
          id="expertise"
          style={{
